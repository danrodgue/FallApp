...
**Campos opcionales:**
- `idFalla`: Para asociar usuario a una falla
- `telefono`: Teléfono de contacto (máx. 20 caracteres)
- `direccion`: Dirección postal (máx. 255 caracteres)
- `ciudad`: Ciudad de residencia (máx. 100 caracteres)
- `codigoPostal`: Código postal (máx. 10 caracteres)
...
```json
{
  ...
  "datos": {
    ...
    "usuario": {
      ...
      "ciudad": null,
      "codigoPostal": null,
      "fechaCreacion": "2026-02-01T18:30:00",
...
```json
{
  ...
  "datos": {
    ...
    "usuario": {
      ...
      "fechaActualizacion": "2026-02-01T18:30:00"
    }
  },
  "timestamp": "2026-02-01T18:30:00"
}
...
```json
{
  ...
  "datos": {
    ...
    "codigoPostal": "46001",
    "fechaCreacion": "2025-01-15T10:00:00",
    "fechaActualizacion": "2026-02-01T14:30:00"
  }
}
```
...
**Descripción:** Permite actualizar los datos de perfil del usuario autenticado.
...
```json
{
  ...
  "datos": {
    ...
    "codigoPostal": "46001",
    "fechaCreacion": "2025-01-15T10:00:00",
    "fechaActualizacion": "2026-02-06T10:30:00"
  }
}
```
...
- ✅ UsuarioDTO completamente documentado con campos opcionales: telefono, direccion, ciudad, codigoPostal
- ✅ Documentación expandida de endpoints de usuarios (registro, login, actualización perfil)
